...
class OnlineVehicleTrackingApp:
    def __init__(
        self,
        video_uuid: str,
        frame_width: int,
        ...
        self.job_duration = int(self.cap.get(cv2.CAP_PROP_FRAME_COUNT)) / frame_rate
    ...
    def decode_video_thread(self):
        ...
        if self.total_frames > 0 and frame_idx >= 0.99 * self.total_frames:
