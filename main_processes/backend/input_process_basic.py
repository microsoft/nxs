...
import numpy as np
from main_processes.backend.input_process import BackendInternalInputProcess
...
class BackendBasicExternalInputProcess(BackendExternalInputProcess):
    def __init__(
        self,
        args: NxsBackendArgs,
...
class BackendBasicInternalInputProcess(BackendInternalInputProcess):
    def __init__(
        self,
        args: NxsBackendArgs,
        component_model: NxsModel,
